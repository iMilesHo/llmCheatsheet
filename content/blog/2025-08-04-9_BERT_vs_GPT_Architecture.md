...
| **3** (3 pts) | **Write the loss function minimized during BERT’s Masked Language Modeling.**                                                                                                                                                                                                                                                                                                    | ( \displaystyle \mathcal{L}_{\text{MLM}} = -; \mathbb{E}_{(x,M)};\sum\_{i\in M}\log p\_\theta!\bigl(x_i ,\big                                                                                                                                                                                                                                                                                                                                                    | , x\_{\setminus M}\bigr) ) where $M$ is the set of masked positions and $x_{\setminus M}$ are the visible tokens. |
